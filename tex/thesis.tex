...
\begin{figure}[htbp]
  \centering
      \includegraphics[height=5cm]{../images/nwp2}
  \caption{A NetworkPolicy allowing ingress from a namespace and egress to a public IP}
  \label{fig:cvepie}
\end{figure}
...
More fine grained and powerful settings can be achieved through the implementation of a Service-Mesh. Istio, a popular service-mesh solution,
provides mutual TLS authentication out of the box. 
