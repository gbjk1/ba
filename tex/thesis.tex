...
programmatic means. The following figures shall depict data on CVE's for the keyword 'Kubernetes'.
\\
\\
\\
\\
\\
insert pie chart with cool stats here
\\
\\
\\
\\
...
This script enables to quickly retrieve the tendencially more severe vulnerabilities. Some CVEs marked with a CVSS base score higher than 7 shall
