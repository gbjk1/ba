...
of exactly this isolation, resulting in full or limited access to the underlying host machine and/or network. Querying the CVE database using 
the search term "container escape" yields 25 results. The most notable ones, which have a severity score above 8, according to the NIST, are 
