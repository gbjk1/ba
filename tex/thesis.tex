...
As reported in CVE-2022-24817, when provided with a kubeconfig file with the correct access rights, such files can be used to define commands to be executed. \cite{CVE-2022-24817}
...
\begin{itemize}
  ...
  \item Authorization to alter a Flux Source's configuration. \cite{flux2}
\end{itemize}
