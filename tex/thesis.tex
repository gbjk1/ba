...
use case is analyzed. Rather a general perspective on the matter is given.  
\newline
\newline
...
are presented. The author approaches the topic more systematically through an evaluation matrix. 
\newline
\newline
