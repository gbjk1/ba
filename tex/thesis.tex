...
Default setting is pods are able to communicate freely 
However it is not necessary for every pod in the cluster to talk to every other pod 
Also not necessary for pods to have access to the internet 
Different type of networkpolicy (Calico/Flannel/Cilium use NATTING at node/vm level)
NetworkPolicy is a simple declaration of networking capabilities. 
