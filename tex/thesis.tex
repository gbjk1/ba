...
To enforce usage of user 1000 on Kubernetes level, 
securityContext:
...
Thus, compromising the container instance through, for example, a reverse shell, gives the perpatrator limited ability to operate 
