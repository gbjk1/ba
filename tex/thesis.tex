...
the Common Vulnerabilities and Exposures database, the IEEE database, the ACM digital library as well as the official
...
\begin{figure}[htbp]
  ...
  \caption{Read access to pods in Kubernetes [source: Garsha Rostami]}
  \label{fig:cvepie}
\end{figure}
